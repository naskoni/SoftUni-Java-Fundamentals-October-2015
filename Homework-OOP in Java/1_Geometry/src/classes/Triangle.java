...
public class Triangle extends PlaneShape {
    ...
    public String toString() {
        return String.format("Triangle[area=%.2f, perimeter=%.2f, sideA=%.2f, sideB=%.2f, "
        		+ "sideC=%.2f, Vertices=%s]", this.getArea(), this.getPerimeter(),
                this.sideA, this.sideB, this.sideC, this.getVertices());
    }
