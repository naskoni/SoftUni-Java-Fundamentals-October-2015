...
public class SquarePyramid extends SpaceShape implements AreaMeasurable, VolumeMeasurable {
    ...
    public String toString() {
        return String.format("SquarePyramid[baseWidth = %.2f, height = %.2f, "
        		+ "volume = %.2f, area = %.2f, vertices = %s]",
                this.baseWidth, this.height, this.getVolume(), this.getArea(), this.getVertices());
    }
}